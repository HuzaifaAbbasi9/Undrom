    ...
    (function (t, e) {
      ...
      !(function (e, s) {
        ...
        for (let t = 0; t < s.length; t++) {
          ...
          let a = [];
          s[t].classList.contains("is-translating") && a.push("translate(" + o / e + "px, " + r / e + "px)"),
          s[t].classList.contains("is-rotating") && a.push("perspective(" + i + "px) rotateY(" + -o / n + "deg) rotateX(" + r / n + "deg)"),
          (s[t].classList.contains("is-translating") || s[t].classList.contains("is-rotating")) &&
          ((a = a.join(" ")), (s[t].style.transform = a), (s[t].style.transition = "transform 1s ease-out"), (s[t].style.transformStyle = "preserve-3d"), (s[t].style.backfaceVisibility = "hidden"));
        }
      })(e, s);
    }, 150)
  );
